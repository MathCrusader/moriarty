...
#include "moriarty/variables/mgraph.h"
...
#include "moriarty/constraints/graph_constraints.h"
...
#include "moriarty/types/graph.h"
#include "moriarty/variables/minteger.h"
#include "moriarty/variables/mstring.h"
...
TEST(MGraphTest, ReadUnweightedAdjMatrixShouldSucceed) {
  ...
  ReadAndVerifyMGraphFromFile(
      graph, "moriarty/variables/testing/mgraph/matrix_sym_binary_0diag.in",
      context);
  ReadAndVerifyMGraphFromFile(
      graph, "moriarty/variables/testing/mgraph/matrix_sym_binary_1diag.in",
      context);
  ReadAndVerifyMGraphFromFile(
      graph, "moriarty/variables/testing/mgraph/matrix_sym_ints_0diag.in", context);
  ReadAndVerifyMGraphFromFile(
      graph, "moriarty/variables/testing/mgraph/matrix_sym_ints_1diag.in", context);
}
...
TEST(MGraphTest, ReadUnweightedEdgeListShouldSucceed) {
  Context context;
  {
    ...
    ReadAndVerifyMGraphFromFile(graph,
                                "moriarty/variables/testing/mgraph/"
