...
#ifndef MORIARTY_SRC_CONTEXTS_INTERNAL_NAME_CONTEXT_H_
#define MORIARTY_SRC_CONTEXTS_INTERNAL_NAME_CONTEXT_H_
...
#endif  // MORIARTY_SRC_CONTEXTS_INTERNAL_NAME_CONTEXT_H_
