...
#ifndef MORIARTY_CONTEXTS_INTERNAL_VARIABLE_ISTREAM_CONTEXT_H_
#define MORIARTY_CONTEXTS_INTERNAL_VARIABLE_ISTREAM_CONTEXT_H_
...
#endif  // MORIARTY_CONTEXTS_INTERNAL_VARIABLE_ISTREAM_CONTEXT_H_
