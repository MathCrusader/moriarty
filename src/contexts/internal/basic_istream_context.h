...
#ifndef MORIARTY_CONTEXTS_INTERNAL_BASIC_ISTREAM_CONTEXT_H_
...
class BasicIStreamContext {
 public:
  explicit BasicIStreamContext(Ref<InputCursor> input);
...
#endif  // MORIARTY_CONTEXTS_INTERNAL_BASIC_ISTREAM_CONTEXT_H_
