...
//   EXPECT_DEATH({ gen3.GenerateTestCases(); }, "without `VariableSet`
//   injected");
// }
...
//   MORIARTY_ASSERT_OK_AND_ASSIGN(std::vector<moriarty_internal::ValueSet>
//   values,
...
//   EmptyGenerator gen;
//   moriarty_internal::GeneratorManager generator_manager(&gen);
//   gen.AddOptionalTestCase().ConstrainVariable("Y", MInteger().Between(50,
//   100));
...
//   // Promote protected functions in `Generator` to public for testing
//   purposes. using Generator::GetVariable; using Generator::HugeValue; using
//   Generator::LargeValue; using Generator::MaxValue; using
//   Generator::MediumValue; using Generator::MinValue; using Generator::Random;
...
//   MORIARTY_EXPECT_OK(
//       ProtectedGenerator().SatisfiesConstraints(MInteger().Between(1, 10),
//       5));
//   EXPECT_THAT(
//       ProtectedGenerator().SatisfiesConstraints(MInteger().Between(1, 10),
//       15), IsUnsatisfiedConstraint("range"));
// }
...
//   EXPECT_DEATH(
//       {
//         (void)ProtectedGenerator(/* should_seed = */ false).RandomInteger(1,
//         2);
//       },
//       "AddGenerator");
//   EXPECT_DEATH(
//       {
//         (void)ProtectedGenerator(/* should_seed = */
//         false).RandomInteger(10);
//       },
//       "AddGenerator");
// }
...
//   ProtectedGenerator G(/* should_seed = */ false);
//   moriarty_internal::VariableSet variables;
//   MORIARTY_ASSERT_OK(variables.AddVariable("x", MInteger().Between(111,
//   122)));
//   moriarty_internal::GeneratorManager(&G).SetGeneralConstraints(variables);
...
//   moriarty_internal::VariableSet variables;
//   MORIARTY_ASSERT_OK(variables.AddVariable("x", MInteger().Between(123,
//   234)));
...
//               IsOkAndHolds(G2.Random(
//                   MInteger().Between(123,
//                   234).WithSize(CommonSize::kTiny))));
//   EXPECT_THAT(G1.SizedValue<MInteger>("x", "small"),
//               IsOkAndHolds(G2.Random(
//                   MInteger().Between(123,
//                   234).WithSize(CommonSize::kSmall))));
//   EXPECT_THAT(G1.SizedValue<MInteger>("x", "medium"),
//               IsOkAndHolds(G2.Random(
//                   MInteger().Between(123,
//                   234).WithSize(CommonSize::kMedium))));
//   EXPECT_THAT(G1.SizedValue<MInteger>("x", "large"),
//               IsOkAndHolds(G2.Random(
//                   MInteger().Between(123,
//                   234).WithSize(CommonSize::kLarge))));
//   EXPECT_THAT(G1.SizedValue<MInteger>("x", "huge"),
//               IsOkAndHolds(G2.Random(
//                   MInteger().Between(123,
//                   234).WithSize(CommonSize::kHuge))));
