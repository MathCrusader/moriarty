...
#ifndef MORIARTY_VARIABLES_CONSTRAINTS_SIZE_CONSTRAINTS_H_
#define MORIARTY_VARIABLES_CONSTRAINTS_SIZE_CONSTRAINTS_H_
...
#endif  // MORIARTY_VARIABLES_CONSTRAINTS_SIZE_CONSTRAINTS_H_
