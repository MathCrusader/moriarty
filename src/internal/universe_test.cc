...
//   EXPECT_THAT(universe.GetOrGenerateAndSetValue<MTestType>("A"),
//               StatusIs(absl::StatusCode::kFailedPrecondition,
//                        HasSubstr("Cannot generate 'A' with a const
//                        ValueSet")));
//   EXPECT_THAT(universe.GetOrGenerateAndSetValue<MTestType>("B"),
//               StatusIs(absl::StatusCode::kFailedPrecondition,
//                        HasSubstr("Cannot generate 'B' with a const
//                        ValueSet")));
// }
...
//   MORIARTY_ASSERT_OK(variables.AddVariable("A",
//   MTestType().Is(TestType(123)))); MORIARTY_ASSERT_OK(variables.AddVariable(
//       "B", MTestType().IsOneOf({TestType(456), TestType(789)})));

//   variables.SetUniverse(&universe);

//   EXPECT_THAT(universe.GetValue<MTestType>("A"),
//   IsOkAndHolds(TestType(123)));
