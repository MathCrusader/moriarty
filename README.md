...
int main() {
  Problem p(
    ...
    Variables(
      ...
      Var("A", MArray<MInteger>(Length("N + 1"), Elements(Between(31, 35)))),
      Var("B", MArray<MString>(Length("N + 1"), Elements(Alphabet("xyz"), Length(Between(1, 4))))),
      Var("X", MInteger())
    ),
    InputFormat(
...
| `MArray<T>`    | `std::vector< ... >`          | `Length("N")`, `Elements(...)`, `DistinctElements()`               |
